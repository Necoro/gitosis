...
.. note::
   ...
   If you don't provide a value for ``readme``, ``gitosis`` will try
   to find it in the repository root.

Finally, you need to include the generated repository list in your cgit
configuration, i.e. add::

    include = /srv/example.com/git/gitosis/repos.list
